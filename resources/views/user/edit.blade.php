            ...
            <form role="form" method="post" >
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="user_id" placeholder="Username" name="user_id" value="{{ $user['user_id'] }}" required="">
                </div>
                <div class="form-group">
                  <label>Name</label>
                ...
                <div class="form-group">
                  <label>Address</label>
                  <input type="text" class="form-control" id="address" placeholder="Address" name="address" value="{{ $user['address'] }}" required>
                </div> 
                <div class="form-group">
                  <label>Email</label>
